...
angular.module('App')
    .controller('ModalEditarCursoCtrl',['$scope','$http' , '$uibModalInstance', 'upload2',  function ($scope, $http, $uibModalInstance, upload2 ) {
        ...
        $scope.Edit = function () {
            ...
            upload2.uploadFile2(file, curso).then(function(res)
            {
                ...
                if (res.data.estado === 0) {
                    alertify.success("Se actualizó correctamente. Actualicé para ver los cambios");
                }else{
